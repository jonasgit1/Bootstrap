...
function JB_after_setup(){
	// Habilita o suporte para o Título da pagina
	add_theme_support('title-tag');
	// Habilita o suporte para a Logo da pagina
	add_theme_support('custom-logo');
	// Habilita o suporte para a Thumbnail dos posts
	add_theme_support('post-thumbnails');
	// Habilita/Registra o suporte para o Menu no Wordpress
	register_nav_menu('primary', __('Primary Menu', 'TemaBoostrap'));
}